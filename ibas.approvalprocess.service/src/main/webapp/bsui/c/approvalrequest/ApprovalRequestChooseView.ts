...
import { IApprovalRequestChooseView } from "../../../bsapp/approvalrequest/index";

/**
 * 视图-ApprovalRequest
 */
export class ApprovalRequestChooseView extends ibas.BOChooseView implements IApprovalRequestChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
            ...
            new sap.m.Button("", {
                ...
                press: function (): void {
                    that.fireViewEvents(that.chooseDataEvent,
                        // 获取表格选中的对象
                        utils.getTableSelecteds<bo.ApprovalRequest>(that.table)
                    );
                }
            }),
            new sap.m.Button("", {
