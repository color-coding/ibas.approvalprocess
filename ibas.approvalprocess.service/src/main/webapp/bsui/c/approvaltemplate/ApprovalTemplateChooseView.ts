...
import { IApprovalTemplateChooseView } from "../../../bsapp/approvaltemplate/index";

/**
 * 视图-ApprovalTemplate
 */
export class ApprovalTemplateChooseView extends ibas.BOChooseView implements IApprovalTemplateChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
            ...
            new sap.m.Button("", {
                ...
                press: function (): void {
                    that.fireViewEvents(that.chooseDataEvent,
                        // 获取表格选中的对象
                        utils.getTableSelecteds<bo.ApprovalTemplate>(that.table)
                    );
                }
            }),
            new sap.m.Button("", {
