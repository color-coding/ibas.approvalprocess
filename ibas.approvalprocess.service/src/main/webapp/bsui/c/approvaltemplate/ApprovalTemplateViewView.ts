...
import { IApprovalTemplateViewView } from "../../../bsapp/approvaltemplate/index";

/**
 * 视图-ApprovalTemplate
 */
export class ApprovalTemplateViewView extends ibas.BOViewView implements IApprovalTemplateViewView {
