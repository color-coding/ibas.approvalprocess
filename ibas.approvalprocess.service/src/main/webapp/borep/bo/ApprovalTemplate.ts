...
/** 审批模板步骤条件 集合 */
export class ApprovalTemplateStepConditions extends BusinessObjects<ApprovalTemplateStepCondition, ApprovalTemplateStep> implements IApprovalTemplateStepConditions {
