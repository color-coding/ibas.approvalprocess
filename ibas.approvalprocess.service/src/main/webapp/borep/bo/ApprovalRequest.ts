...
namespace approvalprocess {
    export namespace bo {
        /** 审批请求 */
        export class ApprovalRequest extends ibas.BOSimple<ApprovalRequest> implements IApprovalRequest {
            ...
            get activated(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(ApprovalRequest.PROPERTY_ACTIVATED_NAME);
            }
            /** 设置-激活的 */
            ...
            get approvalStatus(): ibas.emApprovalStatus {
                return this.getProperty<ibas.emApprovalStatus>(ApprovalRequest.PROPERTY_APPROVALSTATUS_NAME);
            }
            /** 设置-审批状态 */
            ...
            get reentrant(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(ApprovalRequest.PROPERTY_REENTRANT_NAME);
            }
            /** 设置-可重入审批 */
            set reentrant(value: ibas.emYesNo) {
                this.setProperty(ApprovalRequest.PROPERTY_REENTRANT_NAME, value);
            }
            ...
            protected init(): void {
                ...
                this.objectCode = ibas.config.applyVariables(ApprovalRequest.BUSINESS_OBJECT_CODE);
            }
        }
        ...
        /** 审批请求步骤 */
        export class ApprovalRequestStep extends ibas.BOSimpleLine<ApprovalRequestStep> implements IApprovalRequestStep {
            ...
            /** 获取-步骤状态 */
            get stepStatus(): ibas.emApprovalStepStatus {
                return this.getProperty<ibas.emApprovalStepStatus>(ApprovalRequestStep.PROPERTY_STEPSTATUS_NAME);
            }
            /** 设置-步骤状态 */
            set stepStatus(value: ibas.emApprovalStepStatus) {
            ...
            get stepCanModify(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(ApprovalRequestStep.PROPERTY_STEPCANMODIFY_NAME);
            }
            /** 设置-步骤所有者可修改 */
