...
namespace approvalprocess {
    export namespace bo {
        ...
        export interface IApprovalTemplateStep extends ibas.IBOSimpleLine {
            ...
            /** 审批模板步骤所有者集合 */
            approvalTemplateStepOwners: IApprovalTemplateStepOwners;
        ...
        /** 审批模板步骤所有者 集合 */
        export interface IApprovalTemplateStepOwners extends ibas.IBusinessObjects<IApprovalTemplateStepOwner> {
            /** 创建并添加子项 */
            create(): IApprovalTemplateStepOwner;
        }
        ...
        /** 审批模板步骤所有者 */
        export interface IApprovalTemplateStepOwner extends ibas.IBOSimpleLine {
            /** 编号 */
            objectKey: number;
            /** 类型 */
            objectCode: string;
