...
public class ApprovalTemplateStepCondition extends BusinessObject<ApprovalTemplateStepCondition>
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ApprovalTemplateStepCondition.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AP_APT2";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ApprovalTemplateStepCondition";
	 ...
	 * 步骤行号 属性
	 */
	@DbField(name = "StepLineId", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 比较的类型 属性
	 */
	@DbField(name = "Type", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 取值属性 属性
	 */
	@DbField(name = "Alias", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 比较的值 属性
	 */
	@DbField(name = "Value", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 比较的方法 属性
	 */
	@DbField(name = "Operation", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 与上一个条件的关系 属性
	 */
	@DbField(name = "Relationship", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 开括号数 属性
	 */
	@DbField(name = "BracketOpen", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 闭括号数 属性
	 */
	@DbField(name = "BracketClose", type = DataType.NUMERIC, table = DB_TABLE_NAME)
