...
@XmlType(name = ApprovalTemplate.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = ApprovalTemplate.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = ApprovalTemplate.BUSINESS_OBJECT_CODE)
public class ApprovalTemplate extends BusinessObject<ApprovalTemplate> implements IApprovalTemplate {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 1077693288961482613L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ApprovalTemplate.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_AP_OAPT";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ApprovalTemplate";
	 ...
	 * 属性名称-审批模板步骤
	 */
	private static final String PROPERTY_APPROVALTEMPLATESTEPS_NAME = "ApprovalTemplateSteps";

	/**
	 * 审批模板步骤的集合属性
	 * 
	 */
	public static final IPropertyInfo<IApprovalTemplateSteps> PROPERTY_APPROVALTEMPLATESTEPS = registerProperty(
			PROPERTY_APPROVALTEMPLATESTEPS_NAME, IApprovalTemplateSteps.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_APPROVALTEMPLATESTEPS_NAME)
	@XmlElement(name = ApprovalTemplateStep.BUSINESS_OBJECT_NAME, type = ApprovalTemplateStep.class)
	public final IApprovalTemplateSteps getApprovalTemplateSteps() {
		return this.getProperty(PROPERTY_APPROVALTEMPLATESTEPS);
	}
	...
	protected void initialize() {
		...
		this.setApprovalTemplateSteps(new ApprovalTemplateSteps(this));
